...
import addUserDetail from '../../actions/addUserDetail'
      ...
      <div className='container'>
            ...
            <div className="row g-3">
                  ...
                  <div class="text-center">
                        <p>Already member? <Link to="/userLogin">Log In</Link></p>
                  </div>
            </div>
            <br />
      </div>
...
const mapDispatchToProps = (dispatch) =>{
      return {addUserDetail : (detail)=>dispatch(addUserDetail(detail))}
}
