...
-- SELECT FIRST_NAME, LAST_NAME FROM employees where LAST_NAME LIKE '___b'
...
-- SELECT EXTRACT(MONTH FROM HIRE_DATE) AS MONTH1, COUNT(*)
-- FROM employee
-- WHERE EXTRACT(MONTH FROM HIRE_DATE)=1
-- GROUP BY EXTRACT(MONTH FROM HIRE_DATE)

-- Display third highest salary of employees.
-- select * from( select ename, sal, dense_rank() over(order by sal desc)r from Employee) where r=&2;
