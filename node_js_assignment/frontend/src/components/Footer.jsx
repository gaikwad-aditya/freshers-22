...
function Footer() {
  return (
    <div>
                  ...
                  <section className="">
                        ...
                        <div className="row">
                              ...
                              <div className="col-lg-3 col-md-6 mb-4 mb-md-0">
                                    ...
                                    <ul className="list-unstyled mb-0">
                                          <li>
                                                <Link to="/login" className="text-white" style={{textDecoration:'none'}}>Log In</Link>
                                          </li>
                                    </ul>
                              </div>
                              ...
                              <div className="col-lg-3 col-md-6 mb-4 mb-md-0">
                                    ...
                                    <ul className="list-unstyled mb-0">
                                          <li>
                                          <Link to="/createBlog" className="text-white" style={{textDecoration:'none'}}>Create</Link>
                                          </li>
                                    </ul>
                              </div>
            ...
            © 2020 Copyright: <strong>BlogCamp.com</strong>
            </div>
